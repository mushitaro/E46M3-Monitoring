...
// `file://${process.argv[1]}` is not the same string as import.meta.url on Windows: argv[1] is
// `C:\...` with backslashes and the URL is `file:///C:/...` with three slashes and forward ones,
// so the comparison is always false and running this file directly did nothing at all — exit 0,
// no server, no message. pathToFileURL is the portable form.
