 ...
 * USB connection dropped, in the middle of a datalog that runs for a drive, or while an actuator is
 * being held engaged. That is the same window `useUnloadGuard` was built for, and this is the half
 * of it that guard cannot reach.
 *
 * It carries more weight here than in the app this came from, because this one is Android-first by
 * design rather than Android-capable.
 *
 * ## What it is not
 *
 ...
 * removes is the *inactivity* timeout firing halfway through a run — which is the failure that
