...
export const en: Localised = {
    ...
    disclaimer_preview: {
        ...
        records: 'for a job that failed: the ECU, the job, the error text and the communication around it',
        recordsWhen: 'Sent automatically when a job fails. Without a connection they wait on the device and go next time.',
        ...
        deleteBody:
            'You can delete saved sessions and error records in the app at any time. To have everything deleted at once, contact us on Discord.',
