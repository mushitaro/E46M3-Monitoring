...
AIC: dict[str, tuple[str, str]] = {
    ...
    'AIC_INIT_RSK_E46': (
        'ワイパーの戻り接点（Rueckstellkontakt）を初期化します。SGBD: E46 用レインセンサでのみ実行すること。',
        'Initialises the wiper park contact (Rueckstellkontakt). The SGBD says: only on the E46 rain sensor.',
    ),
}
