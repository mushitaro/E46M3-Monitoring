...
BM46WIDE: dict[str, tuple[str, str]] = {
    'STEUERN_DIGITAL': (
        'ラジオ LED を点灯/消灯します（LED_RADIO 1 = 点灯、それ以外 = 消灯）。',
        'Switches the radio LED (LED_RADIO 1 = on, anything else = off).',
    ),
}
