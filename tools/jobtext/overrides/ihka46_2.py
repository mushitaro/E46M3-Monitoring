#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Climate control IHKA (PU98/99) の個別注意文。
...
IHKA46_2: dict[str, tuple[str, str]] = {
    ...
    'STEUERN_RELAIS_FRONTSCHEIBE': (
        'フロントガラス熱線のリレーを EIN/AUS します。SGBD: STEUERN_ZUHEIZER と同一の出力です。AUS で終えること。' + _IHKA_JA,
        'Switches the front-screen heater relay EIN/AUS. The SGBD says this is the same output as STEUERN_ZUHEIZER. Finish with AUS. ' + _IHKA_EN,
    ),
