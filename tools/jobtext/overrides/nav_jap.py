#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Japan navigation system の個別注意文。
...
NAV_JAP: dict[str, tuple[str, str]] = {
    'SYSTEM_RESET': (
        'ナビゲーションユニットが再起動します（SGBD のコメントは「セルフテスト起動」）。案内中のルートは失われます。',
        "The navigation unit reboots (the SGBD comment says 'trigger self-test'). A route in progress is lost.",
    ),
}
