...
VIDEOMOD: dict[str, tuple[str, str]] = {
    'STEUERN_SLEEP_MODE': (
        'ビデオモジュールをスリープさせます。SGBD に起こすジョブは無く、通信は切れ、復帰はイグニッションサイクルです。',
        'Puts the video module to sleep. The SGBD has no wake job — the link drops and recovery is an ignition cycle.',
    ),
}
